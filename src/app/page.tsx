export default async function LandingPage() {
  return (
    <>
      ...
      <section
        id="trust"
        className="flex flex-col text-center items-center space-y-4  text-lg p-10"
      >
        <h1>Trusted by many businesses</h1>
      ...
      <section id="empathy" className="p-10"></section>
      <section id="pain" className="p-10"></section>
      <section id="authority" className="p-10"></section>
      <section
        id="action"
        className="flex flex-col items-center space-y-4 p-10"
      >
        <h1 className="text-6xl w-1/2 text-center">What's Next?</h1>
