    ...
    <>
      ...
      <main className="p-10 lg:p-60 lg:pt-10 lg:pb-10 flex lg:flex-row flex-col-reverse">
        <section className="w-1/2 flex flex-col justify-center space-y-8">
          ...
          <ul className="flex flex-col justify-center space-y-4 pt-10 pb-10">
            <li className="flex flex-row justify-start space-x-2">
              <svg
                ...
                strokeWidth="1.5"
                stroke="currentColor"
                className="w-6 h-6 pt-1 text-orange-500"
              >
                <path
                  strokeLinecap="round"
              ...
              <p>
                <span className="font-bold">Reliable </span>Monitoring across
                your services.
              </p>
            </li>
            <li className="flex flex-row justify-start space-x-2">
              ...
              <p>
                <span className="font-bold">Simple </span>Setup in as little as
                two clicks.
              </p>
            </li>
            <li className="flex flex-row justify-start space-x-2">
              ...
              <p>
                <span className="font-bold">Real-time </span>Status and incident
                reporting.
              </p>
            </li>
          </ul>
          <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-1 lg:space-x-4">
            ...
            <a
              className="p-4 rounded-lg border border-blue-500 text-blue-500"
              href="/book-a-demo"
            >
              Book a Demo
            </a>
        ...
        <section className="w-1/2">
          ...
          >
            ...
            <rect
              ...
              opacity="0.8"
            />
            <rect x="317.60911" y="150" width="16" height="16" fill="#f97316" />
            <rect
              x="271.60911"
              y="251"
              width="16"
            ...
            <rect
              ...
              opacity="0.8"
            />
            <rect x="317.60911" y="251" width="16" height="16" fill="#f97316" />
            <rect
              x="271.60911"
              y="352"
              width="16"
            ...
            <rect
              ...
              opacity="0.8"
            />
            <rect x="317.60911" y="352" width="16" height="16" fill="#f97316" />
      ...
      >
        <section className="w-1/2 flex flex-col justify-center space-y-4">
          ...
          <p>
            <span className="font-bold text-orange-500">HawkStatus</span> offers
            real-time observability, providing you with instant insights into
            the availability and performance of your online services. With
            customizable alerts and an intuitive dashboard,{" "}
            <span className="font-bold text-orange-500">HawkStatus</span>{" "}
            enables you to monitor service health with precision and take
            proactive measures to ensure uninterrupted uptime.
          </p>
        ...
        <section className="w-1/2">
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 816.22047 640.5"
            xmlnsXlink="http://www.w3.org/1999/xlink"
          >
            <path
              id="e5b01265-0b4f-4d57-a9fa-5bd80347d7aa-248"
              data-name="Path 133"
              d="M762.25077,420.88246a363.96429,363.96429,0,0,1-17.004,100.61107c-.2298.75594-.48484,1.50053-.733,2.25647h-63.4504c.06662-.67782.13555-1.43391.20224-2.25647,4.23034-48.63622-19.93841-341.12194-49.10262-391.74353C634.71807,133.85636,767.17043,266.34315,762.25077,420.88246Z"
              transform="translate(-191.88976 -129.75)"
              fill="#f0f0f0"
            />
            <path
              id="ffdef3f3-76d4-4555-b476-c3b551816dea-249"
              data-name="Path 134"
              d="M757.48951,521.49353c-.53077.75594-1.0823,1.512-1.64758,2.25647H708.23978c.36079-.64346.77894-1.39941,1.26378-2.25647C717.36678,507.302,740.64164,464.87,762.246,420.88246c23.20824-47.27131,44.51843-96.33487,42.7238-114.09253C805.526,310.79264,821.59242,432.8864,757.48951,521.49353Z"
              transform="translate(-191.88976 -129.75)"
              fill="#f0f0f0"
            />
            <path
              d="M985.61024,770.25h-586a22.52538,22.52538,0,0,1-22.5-22.5v-284a22.52538,22.52538,0,0,1,22.5-22.5h586a22.52539,22.52539,0,0,1,22.5,22.5v284A22.52539,22.52539,0,0,1,985.61024,770.25Z"
              transform="translate(-191.88976 -129.75)"
              fill="#3f3d56"
            />
            <rect
            ...
            <polygon
              ...
              fill="#cacaca"
            />
            <circle cx="180.89385" cy="237.89146" r="28.93994" fill="#2f2e41" />
            <ellipse
              cx="343.84367"
              cy="345.68703"
              rx="11.97515"
              ry="8.98136"
              transform="translate(-335.61792 214.63358) rotate(-45)"
              fill="#2f2e41"
            />
            <ellipse
              cx="391.93423"
              ...
              rx="8.98136"
              ry="11.97515"
              transform="translate(-264.87845 435.98973) rotate(-66.86956)"
              fill="#2f2e41"
            />
            <circle cx="181.81169" cy="244.80009" r="24.56103" fill="#ffb6b6" />
            <path
              d="M347.89354,359.10128a33.40487,33.40487,0,0,0,19.09068,5.89985,20.47079,20.47079,0,0,1-8.11361,3.338,67.35875,67.35875,0,0,0,27.514.1546,17.80758,17.80758,0,0,0,5.75978-1.97823,7.28923,7.28923,0,0,0,3.55521-4.75471c.60365-3.44852-2.08348-6.58157-4.876-8.69308a35.96737,35.96737,0,0,0-30.22447-6.03968c-3.37626.87272-6.75852,2.34726-8.9515,5.05866s-2.84257,6.8915-.75322,9.68353Z"
              transform="translate(-191.88976 -129.75)"
              fill="#2f2e41"
            />
            <polygon
              points="149.723 534.457 143.168 544.817 100.088 524.463 109.763 509.173 149.723 534.457"
              fill="#ffb6b6"
            />
            <path
              d="M353.32738,667.91881l-21.1365,33.40553-.42254-.26732a15.3873,15.3873,0,0,1-4.776-21.229l.00052-.00083,12.90953-20.40292Z"
              transform="translate(-191.88976 -129.75)"
              fill="#2f2e41"
            />
            <path
              d="M406.28476,402.44857l-58.03335,8.6745-9.97279,23.03184s-22.2116,10.27226-7.44,34.93367l-17.22,62.45624s-80.556,40.875-79.03217,68.2901S318.63862,672.347,318.63862,672.347l11.56862-18.71338-47.67857-47.22867,44.64-14.215,35.21,1.665s38.2542-29.91508,15.49291-79.76l15.69709-46.00081Z"
              transform="translate(-191.88976 -129.75)"
              fill="#cacaca"
            />
            <path
              d="M363.59182,544.1951a9.377,9.377,0,0,0,8.81471-11.35962l40.71618-28.02294-4.81907-12.50716-47.72842,33.41015a9.42779,9.42779,0,0,0,3.0166,18.47957Z"
              transform="translate(-191.88976 -129.75)"
              fill="#ffb6b6"
            />
            <path
              d="M393.36863,411.82874l11.91613-9.38017s15.78611,11.94506,15.80579,20.87325,2.64274,79.78251,2.64274,79.78251L402.44951,518.3499l-19.90088-12.07577,13.68-17.44925-6.45042-40.71268Z"
              transform="translate(-191.88976 -129.75)"
              fill="#cacaca"
            />
            <path
              d="M573.88976,769.75h-381a1,1,0,0,1,0-2h381a1,1,0,0,1,0,2Z"
              transform="translate(-191.88976 -129.75)"
              fill="#3f3d56"
            />
          </svg>
      ...
      <section className="p-10 lg:p-60 lg:pt-10 lg:pb-10 flex flex-col-reverse lg:flex-row lg:space-x-8">
        ...
        <section className="w-1/2 flex flex-col justify-center space-y-4">
          ...
          <p>
            <span className="font-bold text-orange-500">HawkStatus</span> also
            provides powerful historical analytics, allowing you to track and
            analyze service uptime and performance trends over time. With access
            to historical data, you can identify patterns, pinpoint recurring
            issues, and make informed decisions to optimize your online
            presence.
          </p>
          <a className="flex flex-row text-blue-500" href="/signup">
            <p>Get started for free</p>
      ...
      <section className="p-10 lg:p-60 lg:pt-10 lg:pb-10 flex flex-col items-center">
        <section className="lg:w-1/2 flex flex-col justify-center text-center lg:space-y-4">
          ...
          <p>
            <span className="font-bold text-orange-500">HawkStatus</span> offers
            seamless integrations for incident notifications, allowing you to
            connect with your preferred communication channels such as email,
            SMS, Slack, and more. By integrating with these platforms,{" "}
            <span className="font-bold text-orange-500">HawkStatus</span>{" "}
            ensures that you receive timely alerts about service downtime or
            performance issues, enabling swift response and resolution.
          </p>
          <a
            className="flex flex-row  justify-center text-blue-500"
            href="/signup"
          >
            <p>Get started for free</p>
            <svg
      ...
      <section className="p-10 lg:p-60 lg:pt-10 lg:pb-10 flex flex-col justify-center items-center text-center space-y-8">
        <h1 className="pl-40 pr-40 text-5xl font-bold">
          Ready to ensure uninterrupted service uptime and reliability?
        </h1>
        <p>
          Start monitoring with{" "}
          <span className="font-bold text-orange-500">HawkStatus</span> today
          and experience the peace of mind that comes with reliable uptime
          monitoring.
        </p>
      ...
      <section
        id="pricing"
        className="flex flex-col items-center space-y-8 p-10 lg:p-80 lg:pt-10 lg:pb-10"
      >
        ...
        <p>
          Pricing models starting from Personal to Enterprise that suit your
          needs.
        </p>
          ...
          <div className="flex flex-col space-y-8 rounded-3xl p-10 text-left border-blue-500 border-2 scale-105">
            ...
            <ul className="flex flex-col space-y-8">
              <li className="flex flex-row justify-start">
                ...
                <p>
                  All features in <span className="font-bold">Consultant</span>
                </p>
              </li>
              <li className="flex flex-row justify-start">
                <svg
