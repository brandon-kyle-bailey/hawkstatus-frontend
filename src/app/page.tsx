  ...
  return (
    <div className="pt-8 pl-20 pr-20">
      ...
      >
        ...
        <p className="p-10">Check out some of the value Hawkstatus provides.</p>
        <div className="flex flex-wrap flex-row justify-evenly">
          <div className="w-1/4 p-10 ">
            <p>
              <span>Uptime Monitoring</span> Monitor your servers
            </p>
          </div>
          <div className="w-1/4 p-10 ">
            <p>
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eum vero
              quod molestias et. Tenetur, eius animi culpa labore doloremque
              rerum aliquid delectus debitis recusandae distinctio. Impedit
              soluta aspernatur blanditiis tempore!
            </p>
          </div>
        </div>
        <div className="flex flex-wrap flex-row justify-evenly">
