export default async function LandingPage() {
  return (
    <>
      ...
      <section
        id="trust"
        className="flex flex-col text-center items-center space-y-8 text-lg p-10"
      >
      ...
      <section id="empathy" className="flex flex-row p-10">
        ...
        <div className="w-1/2 flex flex-col justify-start space-y-8">
          ...
          <p className="text-lg">
            ...
            accusamus molestiae amet quod inventore, dolor saepe libero! Quis,
            earum.
          </p>
          <div className="flex flex-row space-x-8 text-lg">
            <a href="/signin">Get Started</a>
      ...
      <section
        id="action"
        className="flex flex-col items-center space-y-8 p-10"
      >
