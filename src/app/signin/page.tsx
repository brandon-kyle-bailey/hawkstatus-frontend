...
export default function Signin() {
  return (
    <main className="flex flex-row h-screen w-screen justify-evenly text-2xl bg-gray-100">
      <div
        className={"flex-1 h-screen w-full flex justify-center items-center"}
      >
        <svg
          data-name="Layer 1"
        ...
        >
          ...
          <path
            ...
            fill="#ccc"
          />
          <circle cx="524.99994" cy="335.5" r="16" fill="#ff7f00" />
          <polygon
      ...
      <div className="flex-1 flex justify-center items-center">
        <div className="flex flex-col bg-white rounded-lg p-10 shadow">
          ...
          <CredentialsSigninFormComponent
            ...
            styles={{
              submit: `bg-orange-500 h-14 rounded-md hover:animate-pulse focus:animate-pulse`,
            }}
          />
        </div>
      </div>
