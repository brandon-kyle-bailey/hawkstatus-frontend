  ...
  return (
    <main className="flex flex-row h-max w-screen justify-evenly text-white text-2xl">
      <div
        className={
          heroGradient +
          " bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 flex-1 h-max w-full flex justify-center items-center"
        }
      ></div>
      <div className="flex-1 bg-stone-900 h-max flex justify-center items-center w-full">
