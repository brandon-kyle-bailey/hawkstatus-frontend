        ...
        <div className="flex-auto h-screen w-full bg-gray-200 p-10 space-y-4">
          ...
          <div className="relative shadow-md rounded-lg flex flex-row flex-auto justify-start bg-white">
            <div className="flex justify-between flex-col p-10">
              <h3 className="text-2xl">My Info</h3>
              <div className="flex flex-row flex-auto items-center justify-start space-x-4">
                ...
                ></Image>
                <LinkComponent text="Edit image" url="#" />
              </div>
            ...
            <div className="flex justify-start flex-col p-10">
              <h3 className="text-2xl mb-10">My Preferences</h3>
              <form className="text-gray-600 flex flex-col space-y-6 text-xl">
                <label htmlFor="timezone">My Timezone</label>
                <select
                  name="timezome"
                  id="timezone"
                  className="border h-14 rounded-md p-4"
            ...
            <div className="flex justify-start flex-col p-10">
              <h3 className="text-2xl mb-10">Notifications</h3>
              <form className="text-gray-600 flex flex-col space-y-6 text-xl">
                <div className="flex flex-row flex-auto space-x-4 ">
                  <input
                    ...
                    className="w-8"
                  ></input>
                  <label htmlFor="">Some notification option 1</label>
                </div>
                <div className="flex flex-row flex-auto space-x-4">
                  <input
                    type="checkbox"
